...
如果不认定债权转移：如果认定631号调解书是错误的调解书，如果认定王清芬没权起诉林国付，应撤销631号调解书，也不认定王清芬对王清芳的债务转移到林国付的话。

首先，撤销了调解书的案件需要重审，不是简单划掉一个原告名字就可以了的事情。具体讨论见如下地址：
...
但是我们先假设就是简单划掉一个原告名字，我们也不应该假设王清芬没说过“这就比要不着强”的话，也不应该假设王清芬的承诺和行为所造成的影响就都全部消失。
